...
<head>
  ...
  <link rel="stylesheet" href="{{url(mix('admin/css/chart.css'))}}">
  <link rel="stylesheet" href="{{url(mix('admin/css/dataTables.bootstrap4.css'))}}">
</head>
      ...
      <section class="content">
        <div class="container-fluid">
            ...
            <div class="col-md-3">
              <div class="card card-danger">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <button type="button" class="btn btn-success textDefaultSuccess">
          ...
          <div class="btn-group btn-lg btn-block">
            <button class="btn btn-pink ">Home</button>
            <button class="btn btn-indigo">Produtos</button>
      ...
      <div class="modal-dialog">
        <div class="modal-content bg-primary">
          <div class="modal-header">
            ...
            <div class="card-tools">
              <button type="button" class="btn btn-tool" data-card-widget="card-refresh"
                data-source="/pages/widgets.html" data-source-selector="#modal-primary"><i
                  class="fas fa-sync-alt"></i></button>
              <button type="button" class="btn btn-tool" data-card-widget="maximize"><i
                  class="fas fa-expand"></i></button>
              <button type="button" class="btn btn-tool" data-card-widget="collapse"><i
